...
const init = (getConfigData, B2bElasticSearch, awsHttpClient, Client) => (awsConfig, configTable) => ({
...
module.exports = init(getConfigData, B2bElasticSearch, awsHttpClient, Client);
