module.exports = ({ awsRepositories, getTableName, getErpConfig, erpManager, res }) => ({
  ...
  /** Description.
     * @param  {object} event
     */
  getClientResponseStatus: async event => {
    try {
      console.info('event: ', event);
      console.info('Records[0]: ', event.Records[0]);
      console.info('Records[0].dynamodb: ', event.Records[0].dynamodb);
      console.info('Records[0].dynamodb.NewImage: ', event.Records[0].dynamodb.NewImage);
